...
export default function PrivacyPage() {
	return (
		<Container className="pt-10">
			...
			<p className="mb-4">
				En FiestApp, respetamos tu privacidad y nos comprometemos a proteger la información personal que compartes con
				nosotros.
			</p>
			...
			<p className="mb-4">
				Utilizamos la información para mejorar FiestApp, ofrecerte una mejor experiencia, y mantener la seguridad de la
				plataforma.
			</p>
			...
			<p className="mb-4">Implementamos medidas de seguridad adecuadas para proteger tu información.</p>
