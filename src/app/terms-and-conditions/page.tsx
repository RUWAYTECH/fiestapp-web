...
export default function TermsAndConditionsPage() {
	return (
		<Container className="pt-10">
			...
			<p className="mb-4">
				Bienvenido a <strong>FiestApp</strong>. Al usar nuestros servicios, aceptas los siguientes términos y
				condiciones. Por favor, léelos cuidadosamente.
			</p>

			<h2 className="text-2xl font-semibold mt-6 mb-2">1. Aceptación de los términos</h2>
			<p className="mb-4">
				Al registrarte o usar la aplicación, estás de acuerdo con estos términos. Si no estás de acuerdo, no debes usar
				la app.
			</p>
			...
			<p className="mb-4">
				FiestApp no se hace responsable por el contenido generado por usuarios ni por los eventos organizados. Los
				usuarios son responsables de la veracidad y legalidad de la información que comparten.
			</p>
			...
			<p className="text-sm text-gray-500 mt-6">Última actualización: 16 de abril de 2025</p>
		</Container>
	);
}
