...
export default function Home() {
	const categories = [
		{ id: 1, title: 'Salón de Fiestas', description: 'Espacios', image: 'https://cdn0.matrimonio.com.pe/vendor/8263/3_2/640/jpg/4_11_108263-157332288041700.jpeg', count: 25, rating: 3, priceMin: 500,priceMax:1500, address: 'Av. Central 123, Ciudad' },
	...
	return (
		<AppLayout>
			<div className="flex flex-col items-center justify-center pt-[5vw] pb-8">
			...
			<div className='max-w-full mx-auto p-4 border border-radius-lg bg-base-100 shadow-xl rounded-lg'>
